...
const MainBanner = () => {
  ...
  // Desktop images to rotate
  const desktopBanners = [
    assets.main_banner_bg,
    assets.main_banner_bg2,
    assets.main_banner_bg3,
    assets.main_banner_bg4,
  ];

  const [index, setIndex] = useState(0);

  // Change desktop banner every 4 seconds
  useEffect(() => {
  ...
  return (
    <div className='relative'>
      ...
      <img 
        ...
        alt="banner" 
        className='w-full hidden md:block transition-opacity duration-700'
      />

      {/* Mobile static banner (unchanged) */}
      <img 
...
max-w-72 md:max-w-80 lg:max-w-105 leading-tight lg:leading-[3.5rem]'>
