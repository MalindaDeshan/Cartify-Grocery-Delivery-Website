...
max-w-72 md:max-w-80 lg:max-w-105 leading-tight lg:leading-[3.5rem]'>Fresh Choices, Smart Savings!</h1>
      
      <div className='flex items-center mt-6 font-medium'>
        <Link to={"/products"} className='group flex items-cemter gap-2 px-7 md:px-9 py-3
        bg-primary hover:bg-primary-dull transition rounded text-white cursor-pointer'>
        Shop now
        <img className='md:hidden transition group-focus:translate-x-1' src={assets.white_arrow_icon} alt="arrow" />
        </Link>

        <Link to={"/products"} className='group hiddden md:flex items-center gap-2 px-9 py-3 cursor-pointer'>
        Explore deals
